    ...
    <div className="relative flex flex-col md:flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 max-w-xs md:max-w-3xl mx-auto border border-white bg-white">
      ...
      <div className="w-full md:w-2/3 bg-white flex flex-col space-y-2 p-3">
        ...
        <p className="md:text-base text-gray-500 text-sm">
          ...
          dictionary between 4 and 7 letters long. Your job is to guess the word
          by making letters out of matchsticks, kind of similar to in school how
          everyone used to try to make dirty words on the 7 segment displays of
          old calculators. If you don&apos;t guess the word correctly, the
          matchsticks that are in the right place will burn out giving you a
          hint on what letters are in the word. I&apos;ve also implemented a
          Hint button which uses the ChatGPT API to help you guess the word.
        </p>
      </div>
    </div>
  ),
